...
from mpesa_app.utils import extract_from_pdf, parse_mpesa_content, exec_analytics, find_name, paidin, withdrawal, listing, dfs_tabs
    ...
    if request.method == 'POST':
        try:
            ...
            if content:
                ...
                output = dfs_tabs(dfslist, sheets, content2)
